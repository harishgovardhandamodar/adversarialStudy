...
const transaction_parser_1 = require("./data/transaction-parser");
const privacy_attack_1 = require("./attacks/privacy-attack");
...
async function runAttack() {
    ...
    const transactions = transaction_parser_1.TransactionParser.parseCSV(sampleData);
    console.log("Parsed transactions:", transactions.length);
    // Group by account
    const accounts = transaction_parser_1.TransactionParser.groupByAccount(transactions);
    console.log("Grouped into accounts:", accounts.length);
    // Run privacy attack
    const attack = new privacy_attack_1.PrivacyAttack();
